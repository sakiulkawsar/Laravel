...
<div class="wrapper boxed-wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-layers"></i> <span>Widgets</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="widget-apps.html"><i class="fa fa-angle-right"></i> Apps Widgets</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-two">
      <h1 class="text-white">Apps Widgets</h1>
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> <a href="#">Widgets</a></li>
        <li><i class="fa fa-angle-right"></i> Apps Widgets</li>
      </ol>
    </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="box-body"> 
                ...
                <div class="direct-chat-messages" style="height:530px;">
