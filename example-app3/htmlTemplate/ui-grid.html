      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-frame"></i> <span>UI Elements</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ui-grid.html"><i class="fa fa-angle-right"></i> Grid</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> UI Grid</li>
      </ol>
    </div>
    ...
    <div class="content">
      <div class="card">
      <div class="card-body">
        <h4 class="text-black">Grid options</h4>
        <p>While Bootstrap uses <code class="highlighter-rouge">em</code>s or <code class="highlighter-rouge">rem</code>s for defining most sizes, <code class="highlighter-rouge">px</code>s are used for grid breakpoints and container widths. This is because the viewport width is in pixels and does not change with the <a href="#">font size</a>.</p>
        ...
        <h4 class="text-black m-t-6">Equal-width</h4>
        ...
        <h4 class="text-black m-t-6">Example: Stacked-to-horizontal</h4>
        ...
        <h4 class="text-black m-t-6">Example: Mobile and desktop</h4>
        ...
        <h4 class="text-black m-t-6">Example: Mobile, tablet, desktops</h4>
        ...
        <h4 class="text-black m-t-6">Responsive column resets</h4>
        ...
        <h4 class="text-black m-t-6">Offsetting columns</h4>
