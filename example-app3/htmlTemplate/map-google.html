...
<div class="wrapper boxed-wrapper">
  ...
  <aside class="main-sidebar"> 
    ...
    <div class="sidebar"> 
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-location-pin"></i> <span>Maps</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            <li class="active"><a href="map-google.html"><i class="fa fa-angle-right"></i> Google Maps</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> <a href="#">Maps</a></li>
        <li><i class="fa fa-angle-right"></i> Google Maps</li>
      </ol>
    </div>
    ...
    <div class="content">
      <div class="card">
      <div class="card-body">
        <h4 class="text-black m-b-2">Simple Basic Map</h4>
        <div id="simplemap"></div>
      </div></div>
      <div class="card m-t-3">
      <div class="card-body">
        <h4 class="text-black m-b-2">Map Markers</h4>
        <div id="mapmarker"></div>
      </div></div>
      <div class="card m-t-3">
      <div class="card-body">
        <h4 class="text-black m-b-2">Map Overlay Layer</h4>
        <div id="overlaylayer"></div>
      </div> </div>
      <div class="card m-t-3">
      <div class="card-body">
        <h4 class="text-black m-b-2">Static map with polyline</h4>
        <div id="polyline"></div>
      </div></div>
      <div class="card m-t-3">
      <div class="card-body">
        <h4 class="text-black m-b-2">Styled Maps</h4>
        <div id="styled"></div>
      </div></div>
    </div>
    <!-- /.content --> 
