      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-location-pin"></i> <span>Maps</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="map-vector.html"><i class="fa fa-angle-right"></i> Vector Maps</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> Vector Maps</li>
      </ol>
    </div>
    ...
    <div class="content">
      <div class="info-box">
        <h4 class="m-b-1">World Map</h4>
        <div id="vmap-world" style="width:100%; height:450px;"></div>
      </div>
      <div class="info-box">
        <h4 class="m-b-1">USA Map</h4>
        <div id="vmap-usa" style="width:100%; height:450px;"></div>
      </div>
      <div class="info-box">
        <h4 class="m-b-1">USA Labels</h4>
        <div id="vmap-usal" style="width:100%; height:450px;"></div>
      </div>
    </div>
    <!-- /.content --> 
  </div>
