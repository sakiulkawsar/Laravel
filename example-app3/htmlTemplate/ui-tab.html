      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-frame"></i> <span>UI Elements</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ui-tab.html"><i class="fa fa-angle-right"></i> Tab</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> UI Tabs</li>
      </ol>
    </div>
    ...
    <div class="content">
            ...
            <div class="card-body">
              ...
              <div class="tab-content tabcontent-border">
                <div class="tab-pane active" id="home" role="tabpanel">
                  <div class="pad-20">
                    <h4>Nesciunt stumptown aliqua</h4>
                    <h6>Aliquip placeat salvia cillum iphone</h6>
                    <p>Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui. Reprehenderit butcher retro keffiyeh dreamcatcher.</p>
                  </div>
                </div>
                <div class="tab-pane  p-20" id="profile" role="tabpanel">
                  <div class="pad-20">
                    <h4>Aliqua stumptown nesciunt</h4>
                    <h6>Dalvia aliquip placeat cillum iphone</h6>
                    <p>Reprehenderit butcher retro keffiyeh dreamcatcher. Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui.</p>
                  </div>
                </div>
                <div class="tab-pane p-20" id="messages" role="tabpanel">
                  <div class="pad-20">
                    <h4>Stumptown nesciunt aliqua</h4>
                    <h6>Placeat aliquip salvia cillum iphone</h6>
                    <p>Butcher voluptate nisi qui. Seitan aliquip quis cardigan american apparel, Reprehenderit butcher retro keffiyeh dreamcatcher.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-body p-b-0">
              <h4 class="card-title text-black">Customtab Tab</h4>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="home2" role="tabpanel">
                <div class="pad-20">
                  <h4>Nesciunt stumptown aliqua</h4>
                  <h6>Aliquip placeat salvia cillum iphone</h6>
                  <p>Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui. Reprehenderit butcher retro keffiyeh dreamcatcher cardigan american apparel, butcher voluptate.</p>
                </div>
              </div>
              <div class="tab-pane  p-20" id="profile2" role="tabpanel">
                <div class="pad-20">
                  <h4>Aliqua stumptown nesciunt</h4>
                  <h6>Dalvia aliquip placeat cillum iphone</h6>
                  <p>Reprehenderit butcher retro keffiyeh dreamcatcher. Seitan aliquip quis cardigan american apparel, butcher voluptate nisi qui cardigan american apparel, butcher voluptate.</p>
                </div>
              </div>
              <div class="tab-pane p-20" id="messages2" role="tabpanel">
                <div class="pad-20">
                  <h4>Stumptown nesciunt aliqua</h4>
                  <h6>Placeat aliquip salvia cillum iphone</h6>
                  <p>Butcher voluptate nisi qui. Seitan aliquip quis cardigan american apparel, Reprehenderit butcher retro keffiyeh dreamcatcher cardigan american apparel, butcher voluptate.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row m-b-3">
        <div class="col-md-6">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title text-black">Vertical Tab</h4>
              <h6 class="card-subtitle m-b-2">Use default tab with class <code>vtabs &amp; tabs-vertical</code></h6>
              <!-- Nav tabs -->
              <div class="vtabs">
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="home4" role="tabpanel">
                    <div>
                      <h4>Stumptown nesciunt</h4>
                      <h5>you can use it with the small</h5>
        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title text-black">Customtab vertical Tab</h4>
              <h6 class="card-subtitle m-b-2">Use default tab with class <code>vtabs, tabs-vertical &amp; customvtab</code></h6>
              <!-- Nav tabs -->
      ...
      <div class="row m-b-3">
        <div class="col-md-6">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title m-b-40 text-black">Tab with dropdown</h4>
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> <span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">Dropdown</span> </a>
              ...
              <div class="tab-content tabcontent-border pad-20" id="myTabContent">
                <div role="tabpanel" class="tab-pane fade show active" id="home5" aria-labelledby="home-tab">
                  <p>Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. Reprehenderit butcher retro keffiyeh dreamcatcher synth. Cosby sweater eu banh mi, qui irure terry richardson ex squid. Aliquip placeat salvia cillum.</p>
                </div>
                ...
                <div class="tab-pane fade" id="dropdown2" role="tabpanel" aria-labelledby="dropdown2-tab">
                  <p>Trust fund seitan letterpress, keytar raw denim keffiyeh etsy art party before they sold out master cleanse gluten-free squid scenester freegan cosby sweater. Fanny pack portland seitan DIY, art party locavore wolf cliche high life echo park Austin. Cred vinyl keffiyeh DIY salvia PBR.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-body p-b-0">
              <h4 class="card-title text-black">Customtab2 Tab</h4>
              <h6 class="card-subtitle m-b-2">Use default tab with class <code>customtab</code></h6>
              <!-- Nav tabs -->
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="home7" role="tabpanel">
                  <div class="pad-20">
                    <h4>Best Clean Tab ever</h4>
                    <h5>you can use it with the small code</h5>
                    <p>Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a.</p>
                  </div>
                </div>
      ...
      <div class="row m-b-3">
        <div class="col-md-6">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title text-black">Nav Pills Tabs</h4>
              ...
              <div class="tab-content br-n m-t-2">
                <div id="navpills-1" class="tab-pane active">
                  <div class="row">
                    <div class="col-md-4"> <img src="dist/img/img12.jpg" class="img-responsive thumbnail m-r-15"> </div>
                ...
                <div id="navpills-2" class="tab-pane">
                  <div class="row">
                    <div class="col-md-8"> Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. </div>
                    <div class="col-md-4"> <img src="dist/img/img13.jpg" class="img-responsive thumbnail mr25"> </div>
                  </div>
                </div>
                <div id="navpills-3" class="tab-pane">
                  <div class="row">
                    <div class="col-md-4"> <img src="dist/img/img14.jpg" class="img-responsive thumbnail mr25"> </div>
                    <div class="col-md-8"> Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse. Mustache cliche tempor, williamsburg carles vegan helvetica. </div>
                  </div>
                </div>
              </div>
      ...
      <div class="row m-b-2">
        <div class="col-md-6">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title text-black">Tab with icon</h4>
              <h6 class="card-subtitle m-b-2">Use default tab with class <code>nav-tabs &amp; tabcontent-border </code></h6>
              <!-- Nav tabs -->
              <ul class="nav nav-tabs" role="tablist">
