...
<!-- ion-rangeslider -->
<link rel="stylesheet" href="dist/plugins/ion-rangeslider/ion.rangeSlider.css">
<link rel="stylesheet" href="dist/plugins/ion-rangeslider/ion.rangeSlider.skinModern.css">
...
<div class="wrapper boxed-wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-frame"></i> <span>UI Elements</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ui-range-slider.html"><i class="fa fa-angle-right"></i> Range slider</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      <h1>UI Range slider</h1>
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> <a href="#">UI Elements</a></li>
        <li><i class="fa fa-angle-right"></i> UI Range slider</li>
      </ol>
    </div>
    ...
    <div class="content">
      <div class="card">
        <div class="card-body">
          <h4 class="text-black m-b-2">Start without params</h4>
          <div id="range_01"></div>
          <hr class="m-t-5 m-b-5">
          <h4 class="text-black m-b-2">Set min value, max value and start point</h4>
          <div id="range_02"></div>
          <hr class="m-t-5 m-b-5">
          <h4 class="text-black m-b-2">Set type to double and specify range, also showing grid and adding prefix "$"</h4>
          <div id="range_03"></div>
          <hr class="m-t-5 m-b-5">
          <h4 class="text-black m-b-2">Set up range with negative values</h4>
          <div id="range_04"></div>
          <hr class="m-t-5 m-b-5">
          <h4 class="text-black m-b-2">Whant to show that max number is not the biggest one?</h4>
          <div id="range_16"></div>
          <hr class="m-t-5 m-b-5">
          <h4 class="text-black m-b-2">Remove double decoration</h4>
          <div id="range_18"></div>
          <hr class="m-t-5 m-b-5">
          <h4 class="text-black m-b-2">Visual details</h4>
          <div id="range_22"></div>
        </div>
      </div>
      <!-- Main row --> 
