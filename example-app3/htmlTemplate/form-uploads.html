...
<div class="wrapper boxed-wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-note"></i> <span>Forms</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="form-uploads.html"><i class="fa fa-angle-right"></i> Form File Upload</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-two">
      <h1 class="text-white">Form File Upload</h1>
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> <a href="#">Form</a></li>
        <li><i class="fa fa-angle-right"></i> Form File Upload</li>
      </ol>
    </div>
    ...
    <div class="content">
      ...
      <div class="row m-t-3">
        <div class="col-lg-6 col-md-6">
          <div class="card">
            <div class="card-body">
              <h4 class="text-black">File Upload 3</h4>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <input type="file" id="input-file-now-custom-3" class="dropify" data-height="500" data-default-file="dist/img/img14.jpg" />
            </div>
          </div>
        </div>
      </div>
      <div class="row m-t-3">
        <div class="col-lg-6 col-md-6">
          <div class="card">
            <div class="card-body">
              <h4 class="text-black">File Upload 5</h4>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">File Upload 6</h4>
              <label for="input-file-now-disabled-2">Also with a default file</label>
              <input type="file" id="input-file-now-disabled-2" class="dropify" disabled="disabled" data-default-file="dist/img/img15.jpg" />
            </div>
          </div>
        </div>
      </div>
      <div class="row m-t-3">
        <div class="col-lg-6 col-md-6">
          <div class="card">
            <div class="card-body">
              <h4 class="text-black">File Upload 7</h4>
        ...
        <div class="col-lg-6 col-md-6">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">File Upload 8</h4>
