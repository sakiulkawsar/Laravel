      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-docs"></i> <span>Sample Pages</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="pages-treeview.html"><i class="fa fa-angle-right"></i> Treeview</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> Treeview</li>
      </ol>
    </div>
...
<!-- treeview --> 
<script src="dist/plugins/bootstrap-treeview-master/bootstrap-treeview.min.js"></script> 
<script src="dist/plugins/bootstrap-treeview-master/bootstrap-treeview.int.js"></script>
