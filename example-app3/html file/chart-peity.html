      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"><i class="icon-chart"></i> <span>Charts</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="chart-peity.html"><i class="fa fa-angle-right"></i> Peity Chart</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> Peity Chart</li>
      </ol>
    </div>
          ...
          <div class="info-box">
            <div class="col-12">
              <div class="d-flex flex-wrap">
                <div>
                  <h5>Pie Chart</h5>
                  <h6>Add code in span <code> class="pie"</code></code></h6>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-lg-2 col-md-6 m-b-30"><span class="pie" data-peity='{ "fill": ["#55ce63", "#f2f2f2"]}'>1,4</span>
                <div>Data : 1,4</div>
              </div>
          ...
          <div class="info-box">
            <div class="col-12">
              <div class="d-flex flex-wrap">
                <div>
                  <h5>Donut Chart</h5>
                  <h6>Just add in span<code> class="donut"</code></h6>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-lg-2 col-md-6 m-b-30"><span class="donut" data-peity='{ "fill": ["#55ce63", "#f2f2f2"], "innerRadius": 20, "radius": 32 }'>1,4</span>
                <div>Data : 1,4</div>
              </div>
          ...
          <div class="info-box">
            <div class="col-12">
              <div class="d-flex flex-wrap">
                <div>
                  <h5>Bar Chart</h5>
                  <h6>Add class in span<code> peity-bar</code></h6>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-4 m-b-30"><span class="bar">5,3,9,6,5,9,7,3,5,2</span></div>
              <div class="col-lg-4 m-b-30"><span class="bar">5,3,2,-1,-3,-2,2,3,5,2</span></div>
              <div class="col-lg-4 m-b-30"><span class="bar">0,-3,-6,-4,-5,-4,-7,-3,-5,-2</span></div>
            </div>
          </div>
        </div>
        <div class="col-lg-12">
          <div class="info-box">
            <div class="col-12">
              <div class="d-flex flex-wrap">
                <div>
                  <h5>Line Chart</h5>
                  <h6>Add class in span<code> peity-line</code></h6>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-4 m-b-30"><span class="line">5,3,9,6,5,9,7,3,5,2</span></div>
              <div class="col-lg-4 m-b-30"><span class="line">5,3,2,-1,-3,-2,2,3,5,2</span></div>
              <div class="col-lg-4 m-b-30"><span class="line">0,-3,-6,-4,-5,-4,-7,-3,-5,-2</span></div>
            </div>
          </div>
        </div>
      </div>
