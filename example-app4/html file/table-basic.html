    ...
    <div class="sidebar"> 
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="fa fa-table"></i> <span>Tables</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            <li class="active"><a href="table-basic.html"><i class="fa fa-angle-right"></i> Basic Tables</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content">
      ...
      <div class="card-body">
        ...
        <h4 class="text-black">Hoverable rows</h4>
        ...
        <hr class="m-t-1 m-b-3">
        <h4 class="text-black">Table head options</h4>
        ...
        <div class="row">
          <div class="col-lg-6">
            <h4 class="text-black">Striped rows</h4>
          ...
          <div class="col-lg-6">
            <h4 class="text-black">Bordered table</h4>
