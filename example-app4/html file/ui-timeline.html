      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-frame"></i> <span>UI Elements</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ui-timeline.html"><i class="fa fa-angle-right"></i> Timeline</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> UI Timeline</li>
      </ol>
    </div>
    ...
    <div class="content">
      <div class="card">
        <div class="card-body">
          <ul class="timeline">
            <li>
              <div class="timeline-badge primary"><img src="dist/img/img1.jpg" class="img-circle img-responsive"></div>
              <div class="timeline-panel">
                <div class="timeline-heading"> <img class="img-responsive" src="dist/img/img9.jpg" /> </div>
                ...
                <div class="timeline-footer"> <a><i class="fa fa-thumbs-o-up"></i></a> <a><i class="fa fa-edit"></i></a> <a class="pull-right">Continuar Lendo</a> </div>
              </div>
            </li>
            <li  class="timeline-inverted">
              <div class="timeline-badge primary"><img src="dist/img/img2.jpg" class="img-circle img-responsive"></div>
              <div class="timeline-panel">
                <div class="timeline-heading"> <img class="img-responsive" src="dist/img/img10.jpg" /> </div>
                <div class="timeline-body">
                  <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.</p>
                </div>
                <div class="timeline-footer"> <a><i class="fa fa-thumbs-o-up"></i></a> <a><i class="fa fa-edit"></i></a> <a class="pull-right">Continuar Lendo</a> </div>
            ...
            <li>
              <div class="timeline-badge primary"><img src="dist/img/img3.jpg" class="img-circle img-responsive"></div>
              <div class="timeline-panel">
                <div class="timeline-heading"> <img class="img-responsive" src="dist/img/img7.jpg" /> </div>
                <div class="timeline-body">
                  <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga. </p>
                </div>
                <div class="timeline-footer"> <a><i class="fa fa-thumbs-o-up"></i></a> <a><i class="fa fa-edit"></i></a> <a class="pull-right">Continuar Lendo</a> </div>
            ...
            <li  class="timeline-inverted">
              <div class="timeline-badge primary"><img src="dist/img/img4.jpg" class="img-circle img-responsive"></div>
              <div class="timeline-panel">
                <div class="timeline-body">
                  <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.</p>
                </div>
            ...
            <li>
              <div class="timeline-badge primary"><img src="dist/img/img2.jpg" class="img-circle img-responsive"></div>
              <div class="timeline-panel">
                <div class="timeline-heading"> <img class="img-responsive" src="dist/img/img8.jpg" /> </div>
                <div class="timeline-body">
                  <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.</p>
                </div>
                <div class="timeline-footer"> <a><i class="fa fa-thumbs-o-up"></i></a> <a><i class="fa fa-edit"></i></a> <a class="pull-right">Continuar Lendo</a> </div>
            ...
            <li  class="timeline-inverted sty-1">
              <div class="timeline-badge primary"><img src="dist/img/img1.jpg" class="img-circle img-responsive"></div>
              <div class="timeline-panel">
                <div class="timeline-heading"> <img class="img-responsive" src="dist/img/img9.jpg" /> </div>
                <div class="timeline-body">
                ...
                <div class="timeline-footer primary"> <a><i class="fa fa-thumbs-o-up"></i></a> <a><i class="fa fa-edit"></i></a> <a class="pull-right">Continuar Lendo</a> </div>
              </div>
            </li>
            <li>
              <div class="timeline-badge primary"><img src="dist/img/img5.jpg" class="img-circle img-responsive"></div>
              <div class="timeline-panel">
                <div class="timeline-body">
