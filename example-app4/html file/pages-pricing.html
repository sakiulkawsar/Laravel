      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-docs"></i> <span>Sample Pages</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="pages-pricing.html"><i class="fa fa-angle-right"></i> Pricing</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> Pricing</li>
      </ol>
    </div>
    ...
    <div class="content">
      <div class="card">
      <div class="card-body">
        <h4 class="m-b-3">Pricing Table 1</h4>
        <div class="row">
          <div class="col-lg-3">
            <div class="pricing-box text-center">
              ...
              <div class="button m-t-2"><a href="#" class="btn btn-primary">SIGN UP</a></div>
            </div>
          </div>
          <div class="col-lg-3">
            <div class="pricing-box active text-center">
              ...
              <div class="button m-t-2"><a href="#" class="btn btn-success">SIGN UP</a></div>
            </div>
          </div>
          <div class="col-lg-3">
            <div class="pricing-box text-center">
        ...
        <h4 class="m-t-6 m-b-2">Pricing Table 1</h4>
        <div class="row">
          <div class="col-lg-4">
            <div class="pricing-box sty1 text-center">
              <div class="price sty1">
                <h5>Silver</h5>
                <h2>25</h2>
                <small>per month</small> </div>
              <ul class="plan-list">
