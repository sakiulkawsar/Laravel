...
<div class="wrapper boxed-wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-home"></i> <span>Dashboard</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="index-analytics.html"><i class="fa fa-angle-right"></i> Analytics</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-two">
      <h1 class="text-white">Dashboard Analytics</h1>
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> Dashboard Analytics</li>
      </ol>
    </div>
    ...
    <div class="content">
      <div class="row">
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12 m-b-3">
          <div class="bg-danger">
            <div class="card-body"> <span class="info-box-icon bg-transparent"><i class="ti-face-smile text-white"></i></span>
              <div class="info-box-content">
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12 m-b-3">
          <div class="bg-blue">
            <div class="card-body"> <span class="info-box-icon bg-transparent"><i class="ti-bar-chart text-white"></i></span>
              <div class="info-box-content">
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12 m-b-3">
          <div class="bg-dark">
            <div class="card-body"> <span class="info-box-icon bg-transparent"><i class="ti-money text-white"></i></span>
              <div class="info-box-content">
      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="card m-b-3">
            <div class="card-body">
              <h5 class="m-b-1">Statistics</h5>
              <div class="row m-t-2 m-b-1">
                <div class="col-md-4">
                  <h6 class="text-blue font-weight-bold">Organic Traffic</h6>
                  <p class="f-13">+ 65% this month</p>
                </div>
                <div class="col-md-4">
                  <h6 class="text-orange font-weight-bold">Page Views</h6>
                  <p class="f-13">+ 75% this month</p>
                </div>
                <div class="col-md-4">
                  <h6 class="text-aqua font-weight-bold">Bounce Rate</h6>
                  <p class="f-13">+ 5% this month</p>
                </div>
              </div>
        ...
        <div class="col-lg-4">
          <div class="card m-b-3">
            <div class="card-body">
              <h5 class="m-b-2">Marketplaces</h5>
              <div class="row">
                <div class="col-xl-4 m-b-1 text-center">
                  <h6>In Store</h6>
                  <h6 class="text-blue">9,500</h6>
                </div>
                <div class="col-xl-4 m-b-1 text-center">
                  <h6 class="f-14">Mail Order</h6>
                  <h4 class="text-orange">1,500</h4>
                </div>
                <div class="col-xl-4 m-b-1 text-center">
                  <h6 class="f-14">New Order</h6>
                  <h4 class="text-aqua">3,500</h4>
                </div>
              </div>
          ...
          <div class="widget-info bg-primary">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6 m-t-2 text-right"> <span id="spa-bar">
                  <canvas style="display: inline-block; width: 102px; height: 70px; vertical-align: top;" width="102" height="70"></canvas>
                  </span> </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-6 text-white">
                  ...
                  <a href="#">View Statement</a> </div>
                <div class="col-md-6 m-t-2 text-right"> <span id="spa-line">
                  <canvas style="display: inline-block; height: 70px; vertical-align: top; width: 120px;" width="120" height="70"></canvas>
                  </span> </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-6 text-white">
                  ...
                  <a href="#">View Statement</a> </div>
                <div class="col-md-6 m-t-2 text-right"> <span id="spa-pie">
                  <canvas style="display: inline-block; width: 70px; height: 70px; vertical-align: top;" width="70" height="70"></canvas>
                  </span> </div>
              </div>
            </div>
          </div>
