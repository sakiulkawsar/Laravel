    ...
    <div class="sidebar"> 
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-energy"></i> <span>Icons</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            <li class="active"><a href="icon-fontawesome.html"><i class="fa fa-angle-right"></i> Fontawesome Icons</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> Fontawesome Icons</li>
      </ol>
    </div>
    ...
    <div class="content">
      <div class="card">
      <div class="card-body">
        <h4 class="text-black">41 New Icons in 4.7</h4>
        <p>use the icon by just put class <code>fa fa-address-book</code> in i tag </p>
        ...
        <h4 class="text-black m-t-4">File Type Icons</h4>
        ...
        <h4 class="text-black m-t-4">Spinner Icons</h4>
        ...
        <h4 class="text-black m-t-4">Form Control Icons</h4>
        <div class="row fontawesome-icon-list">
          <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-check-square"></i> fa-check-square</div>
          <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-check-square-o"></i> fa-check-square-o</div>
          <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-circle"></i> fa-circle</div>
        ...
        <h4 class="text-black m-t-4">Currency Icons</h4>
        <div class="row fontawesome-icon-list">
        ...
        <h4 class="text-black m-t-4">Directional Icons</h4>
        <div class="row fontawesome-icon-list">
        ...
        <h4 class="text-black m-t-4">Video Player Icons</h4>
        <div class="row fontawesome-icon-list">
          <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-arrows-alt"></i> fa-arrows-alt</div>
        ...
        <h4 class="text-black m-t-4">Medical Icons</h4>
        <div class="row fontawesome-icon-list">
