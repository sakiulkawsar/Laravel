      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-docs"></i> <span>Sample Pages</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="pages-gallery.html"><i class="fa fa-angle-right"></i> Gallery</a></li>
          ...
          <div class="col-lg-12">
            <div class="chart-box">
              <div id="js-filters-masonry" class="cbp-l-filters-alignRight">
                ...
                <div data-filter=".graphic, .identity" class="cbp-filter-item"> Web Design & Identity
                  <div class="cbp-filter-counter"></div>
                </div>
              </div>
              <div id="js-grid-masonry" class="cbp">
                <div class="cbp-item identity"> <a href="dist/img/media/portfolio-6.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb6.jpg" alt=""> </div>
                ...
                <div class="cbp-item web-design"> <a href="dist/img/media/portfolio-2.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb2.jpg" alt=""> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title">Setting Simply Dummy</div>
                ...
                <div class="cbp-item graphic identity"> <a href="dist/img/media/portfolio-3.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb3.jpg" alt=""> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title">Setting Simply Dummy</div>
                ...
                <div class="cbp-item graphic"> <a href="dist/img/media/portfolio-4.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb4.jpg" alt=""> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title">Setting Simply Dummy</div>
                ...
                <div class="cbp-item identity"> <a href="dist/img/media/portfolio-5.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb5.jpg" alt=""> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title">Setting Simply Dummy</div>
                ...
                <div class="cbp-item graphic"> <a href="dist/img/media/portfolio-1.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb1.jpg" alt=""> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title">Setting Simply Dummy</div>
                ...
                <div class="cbp-item web-design"> <a href="dist/img/media/portfolio-7.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb7.jpg" alt=""> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title">Setting Simply Dummy</div>
                ...
                <div class="cbp-item identity"> <a href="dist/img/media/portfolio-8.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb8.jpg" alt=""> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title">Setting Simply Dummy</div>
                ...
                <div class="cbp-item identity"> <a href="dist/img/media/portfolio-9.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb9.jpg" alt=""> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title">Setting Simply Dummy</div>
                ...
                <div class="cbp-item web-design graphic"> <a href="dist/img/media/portfolio-10.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb10.jpg" alt=""> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title">Setting Simply Dummy</div>
                ...
                <div class="cbp-item web-design graphic"> <a href="dist/img/media/portfolio-11.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb11.jpg" alt=""> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title">Setting Simply Dummy</div>
                ...
                <div class="cbp-item web-design graphic"> <a href="dist/img/media/portfolio-12.jpg" class="cbp-caption cbp-lightbox" data-title="Setting Simply Dummy<br>by UXLiner">
                  <div class="cbp-caption-defaultWrap"> <img src="dist/img/media/thumb/thumb12.jpg" alt=""> </div>
                  <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                      <div class="cbp-l-caption-body">
                        <div class="cbp-l-caption-title">Setting Simply Dummy</div>
...
<!--cubeportfolio--> 
<!-- load jquery --> 
<script  src="dist/plugins/cubeportfolio/jquery-latest.min.js"></script> 
<!-- load cubeportfolio --> 
<script  src="dist/plugins/cubeportfolio/jquery.cubeportfolio.min.js"></script> 
<!-- init cubeportfolio --> 
<script  src="dist/plugins/cubeportfolio/main.js"></script>
