...
<div class="wrapper boxed-wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-frame"></i> <span>UI Elements</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ui-progressbar.html"><i class="fa fa-angle-right"></i> Progressbar</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      <h1>UI Progressbar</h1>
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> <a href="#">UI Elements</a></li>
        <li><i class="fa fa-angle-right"></i> UI Progressbar</li>
      </ol>
    </div>
    
    <!-- Main content -->
    <div class="content pro-sty1">
      <div class="card">
        <div class="card-body">
          <h4 class="text-black">Basic Example</h4>
      ...
      <div class="card m-t-3">
        <div class="card-body">
          <h4 class="text-black">Backgrounds</h4>
          <p>Add labels to your progress bars by placing text within the <code class="highlighter-rouge">.bg-success</code>.</p>
          <div class="progress">
          ...
          <div class="progress m-t-3">
            <div class="progress-bar bg-danger" role="progressbar" style="width: 65%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">65%</div>
          </div>
          <div class="progress m-t-3">
      ...
      <div class="card m-t-3">
        <div class="card-body">
          <h4 class="text-black">Striped</h4>
      ...
      <div class="card m-t-3">
        <div class="card-body">
          <h4 class="text-black">Animated stripes</h4>
          ...
          <div class="progress m-t-3">
            <div class="progress-bar progress-bar-striped bg-danger progress-bar-animated" role="progressbar" style="width: 85%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
          <div class="progress m-t-3">
