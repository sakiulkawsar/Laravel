...
<div class="content-wrapper">
  ...
  <div class="content-header sty-one">
    <h1 class="text-white">Edit Form</h1>
    <ol class="breadcrumb">
      <li><a href="#">Home</a></li>
      <li><i class="fa fa-angle-right"></i> <a href="#">Form</a></li>
      <li><i class="fa fa-angle-right"></i>Edit Form</li>
    </ol>
  </div>
          ...
          <div class="card-body">
            ...
            <form action="{{route('category.update',$category->id)}}" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" name="cat_name" value="{{!old('cat_name') ? $category->name :old('cat_name')}}" class="form-control" id="exampleInputEmail1" placeholder="Enter Category Name">
              </div>
