      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-frame"></i> <span>UI Elements</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ui-typography.html"><i class="fa fa-angle-right"></i> Typography</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> UI Typography</li>
      </ol>
    </div>
    ...
    <div class="content">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-lg-6">
            <h4 class="text-black">Typography</h4>
          ...
          <div class="col-lg-6">
            <h4 class="text-black">Heading with subtitle</h4>
            <p>Use tags <code>h1 to h6</code> for get desire heading.</p>
          ...
          <div class="col-lg-5">
            <h4 class="text-black">Paragraph with justify</h4>
          ...
          <div class="col-lg-6 offset-lg-1">
            <h4 class="text-black">Alignment text</h4>
          ...
          <div class="col-lg-6">
            <h4 class="text-black">View port text</h4>
          ...
          <div class="col-lg-6">
            <h4 class="text-black">Font weight and italics</h4>
            <p>Use tags <code>font-weight-bold, font-weight-normal, font-weight-italic</code> for get desire text.</p>
          ...
          <div class="col-lg-4">
            <h4 class="text-black">Text colors</h4>
          ...
          <div class="col-lg-4">
            <h4 class="text-black">Blockquotes</h4>
          ...
          <div class="col-lg-4">
            <h4 class="text-black">Description Text</h4>
          ...
          <div class="col-lg-4">
            <h4 class="text-black">Fancy Listing 1</h4>
          ...
          <div class="col-lg-4">
            <h4 class="text-black">Fancy Listing with href</h4>
            <p>Use class <code>list-icons</code>to ul for get desire ol list.</p>
            <ul class="list-icons">
