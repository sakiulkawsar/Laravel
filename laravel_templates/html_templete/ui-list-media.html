      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-frame"></i> <span>UI Elements</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ui-list-media.html"><i class="fa fa-angle-right"></i> List Media</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> UI List Media</li>
      </ol>
    </div>
    ...
    <div class="content">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-lg-6 col-sm-6 m-b-3">
            <h4 class="text-black">With Badges</h4>
          ...
          <div class="col-lg-6 col-sm-6 m-b-3">
            <h4 class="text-black">Linked Items</h4>
          ...
          <div class="col-lg-6 col-sm-6 m-b-3">
            <h4 class="text-black">Custom Content</h4>
          ...
          <div class="col-lg-6 col-sm-4 m-b-6">
            <h4 class="text-black">Button Items</h4>
          ...
          <div class="col-lg-6 col-sm-6 m-b-3">
            <h4 class="text-black">Disabled Items</h4>
