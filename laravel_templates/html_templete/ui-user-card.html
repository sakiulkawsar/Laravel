      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-frame"></i> <span>UI Elements</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ui-user-card.html"><i class="fa fa-angle-right"></i> User Cards</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> UI User Cards</li>
      </ol>
    </div>
    ...
    <div class="content">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 m-b-3"> 
            <!-- Card -->
            <div class="card"> <img class="card-img-top img-responsive" src="dist/img/img13.jpg" alt="Card image cap">
              <div class="card-body">
                <h4 class="card-title">Card title</h4>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="#" class="btn btn-primary">Go somewhere</a> </div>
          ...
          <div class="col-lg-4 m-b-3"> 
            <!-- Card -->
            <div class="card"> <img class="card-img-top img-responsive" src="dist/img/img14.jpg" alt="Card image cap">
              <div class="card-body">
                <h4 class="card-title">Card title</h4>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <a href="#" class="btn btn-primary">Go somewhere</a> </div>
          ...
          <div class="col-lg-12 m-t-6">
            <h4 class="text-black">Titles, text, and links</h4>
          ...
          <div class="col-lg-12 m-t-6">
            <h4 class="text-black">Header and footer</h4>
          ...
          <div class="col-lg-12 m-t-6">
            <h4 class="text-black">Size Using grid markup</h4>
              ...
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Special title treatment</h4>
                    <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                    <a href="#" class="btn btn-warning">Go somewhere</a> </div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-12 m-t-6">
            <h4 class="text-black">Text alignment</h4>
          ...
          <div class="col-lg-12 m-t-6">
            <h4 class="text-black">Background and color</h4>
          ...
          <div class="col-lg-12 m-t-6">
            <h4 class="text-black">Card columns</h4>
              ...
              <div class="card-columns">
                ...
                <div class="card p-3">
                  <blockquote class="blockquote mb-0 card-body">
                    ...
                    <footer class="blockquote-footer"> <small class="text-muted"> Someone famous in <cite title="Source Title">Source Title</cite> </small> </footer>
                  </blockquote>
                </div>
                <div class="card"> <img class="card-img-top img-responsive" src="dist/img/img14.jpg" alt="Card image cap">
                  <div class="card-body">
                ...
                <div class="card bg-primary p-3 text-center">
                  <blockquote class="blockquote text-white mb-0">
                    ...
                    <footer class="blockquote-footer text-white"> <small> Someone famous in <cite title="Source Title">Source Title</cite> </small> </footer>
                  </blockquote>
                </div>
                <div class="card text-center">
                  <div class="card-body">
                ...
                <div class="card"> <img class="card-img-top img-responsive" src="dist/img/img15.jpg" alt="Card image cap"> </div>
