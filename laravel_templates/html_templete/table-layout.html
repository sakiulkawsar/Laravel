      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="fa fa-table"></i> <span>Tables</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="table-layout.html"><i class="fa fa-angle-right"></i> Table Layouts</a></li>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-lg-6 m-b-3">
            <h4 class="text-black">Primary Table</h4>
            <p>Add class to the thead <code>.bg-primary</code></p>
          ...
          <div class="col-lg-6 m-b-3">
            <h4 class="text-black">Success Table</h4>
            <p>Add class to the thead <code>.bg-success</code></p>
            <div class="table-responsive">
              <table class="table">
          ...
          <div class="col-lg-6 m-b-3">
            <h4 class="text-black">Info Table</h4>
            <p>Add class to the thead <code>.bg-info</code></p>
            <div class="table-responsive">
              <table class="table">
          ...
          <div class="col-lg-6 m-b-3">
            <h4 class="text-black">Warning Table</h4>
            <p>Add class to the thead <code>.bg-warning</code></p>
            <div class="table-responsive">
              <table class="table">
          ...
          <div class="col-lg-6 m-b-3">
            <h4 class="text-black">Danger Table</h4>
            <p>Add class to the thead <code>.bg-danger</code></p>
            <div class="table-responsive">
              <table class="table">
          ...
          <div class="col-lg-6 m-b-3">
            <h4 class="text-black">Inverse Table</h4>
            <p>Add class to the thead <code>.bg-inverse</code></p>
            <div class="table-responsive">
              <table class="table">
          ...
          <div class="col-lg-6 m-b-3">
            <h4 class="text-black">Dark Table</h4>
            <p>Add class to the thead <code>.bg-dark</code></p>
            <div class="table-responsive">
              <table class="table">
          ...
          <div class="col-lg-6 m-b-3">
            <h4 class="text-black">Lime Table</h4>
            <p>Add class to the thead <code>.bg-lime</code></p>
            <div class="table-responsive">
              <table class="table">
                <thead class="bg-lime text-white">
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col">First Name</th>
                    <th scope="col">Last Name</th>
          ...
          <div class="col-lg-6 m-b-3">
            <h4 class="text-black">Purple Table</h4>
            <p>Add class to the thead <code>.bg-purple</code></p>
            <div class="table-responsive">
              <table class="table">
          ...
          <div class="col-lg-6 m-b-3">
            <h4 class="text-black">Maroon Table</h4>
            <p>Add class to the thead <code>.bg-maroon</code></p>
            <div class="table-responsive">
              <table class="table">
