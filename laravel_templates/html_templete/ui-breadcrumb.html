      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-frame"></i> <span>UI Elements</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="ui-breadcrumb.html"><i class="fa fa-angle-right"></i> Breadcrumb</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> UI Breadcrumb</li>
      </ol>
    </div>
    ...
    <div class="content">
      <div class="card">
      <div class="card-body">
        <h4 class="text-black">Bootstrap Breadcrumb</h4>
        <p>Separators are automatically added in CSS through <code class="highlighter-rouge">::before</code> and <code class="highlighter-rouge">content</code>.</p>
        ...
        <h4 class="text-black">Nav breadcrumb</h4>
        <p>use class <code>.breadcrumb to nav</code> similar to navigation</p>
        ...
        <hr class="m-t-5 m-t-5">
        <h4 class="text-black">Colored Breadcrumb</h4>
        <p>use class <code>.bc-colored .bg-primary</code> similar to navigation</p>
        ...
        <ol class="breadcrumb bc-colored bg-warning m-b-3">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item active">Library</li>
        </ol>
        <ol class="breadcrumb bc-colored bg-secondary m-b-3">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item active">Library</li>
        </ol>
        <ol class="breadcrumb bc-colored bg-info m-b-3">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item active">Library</li>
        </ol>
        <ol class="breadcrumb bc-colored bg-purple m-b-3">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item active">Library</li>
        </ol>
      </div></div>
