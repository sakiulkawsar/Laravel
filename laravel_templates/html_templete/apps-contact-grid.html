...
<div class="wrapper boxed-wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-grid"></i> <span>Apps</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="apps-contact-grid.html"><i class="fa fa-angle-right"></i> Contact  Grid</a></li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-two">
      <h1 class="text-white">Contact Grid</h1>
      <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><i class="fa fa-angle-right"></i> <a href="#">Apps</a></li>
        <li><i class="fa fa-angle-right"></i> Contact Grid</li>
      </ol>
    </div>
      ...
      <div class="row">
        <div class="col-lg-6 m-b-3">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-3">
                <div class="user-img pull-left"> <img src="dist/img/img1.jpg" class="img-circle img-responsive" alt="User Image"> </div>
              </div>
              <div class="col-lg-9">
                <div class="mail-contnet">
                  <h4 class="text-black m-b-0">Alexander Pierce</h4>
                  <small>Web Designer</small>
                  <p class="m-t-1">795 Crossover Lane, Folsom Ave, Suite 600,<br>
                    San Francisco, CA 94107</p>
                  <abbr title="Phone">P:</abbr> (123) 456-7890 </div>
              </div>
            </div>
          </div></div>
        </div>
        <div class="col-lg-6 m-b-3">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-3">
                <div class="user-img pull-left"> <img src="dist/img/img2.jpg" class="img-circle img-responsive" alt="User Image"> </div>
              </div>
              <div class="col-lg-9">
                <div class="mail-contnet">
                  <h4 class="text-black m-b-0">Alexander Pierce</h4>
        ...
        <div class="col-lg-6 m-b-3">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-3">
                <div class="user-img pull-left"> <img src="dist/img/img4.jpg" class="img-circle img-responsive" alt="User Image"> </div>
              </div>
              <div class="col-lg-9">
                <div class="mail-contnet">
                  <h4 class="text-black m-b-0">Alexander Pierce</h4>
