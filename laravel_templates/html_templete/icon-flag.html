      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview"> <a href="#"> <i class="icon-energy"></i> <span>Icons</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="icon-flag.html"><i class="fa fa-angle-right"></i> Flag Icons</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-angle-right"></i> Flag Icons</li>
      </ol>
    </div>
    ...
    <div class="content">
      <div class="card">
      <div class="card-body">
        <h4 class="text-black">Flag Icons</h4>
        <div class="flag-icon-list row">
